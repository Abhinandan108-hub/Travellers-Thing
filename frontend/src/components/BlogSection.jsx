...
export default function BlogSection() {
    const ref = useFadeUp();
    return (<section id="blog" className="section-padding bg-stats-bg" ref={ref}>
      <div className="container-wide">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
          {posts.map((post, i) => (<article key={post.title} className="fade-up bg-background rounded-lg overflow-hidden shadow-md group cursor-pointer" style={{ animationDelay: `${i * 0.1}s` }}>

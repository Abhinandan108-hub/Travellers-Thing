...
export default function Footer() {
  return (
    <footer id="contact" className="bg-footer-bg pt-20 pb-8">
            ...
            <ul className="space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link}>
                  <a
                    href="#"
                    className="text-sm text-footer-foreground hover:text-footer-heading transition-colors duration-200"
                  >
                    {link}
                  </a>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {contactInfo.map((line) => (
                <li key={line} className="text-sm text-footer-foreground">
                  {line}
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <div className="flex">
              <input
                ...
                className="flex-1 px-4 py-2.5 bg-footer-foreground/10 text-sm text-footer-heading placeholder:text-footer-foreground/50 rounded-l-md outline-none border border-footer-foreground/20 focus:border-primary transition-colors"
              />

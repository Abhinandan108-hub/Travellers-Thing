...
export default function HeroSection() {
    return (<section className="relative h-screen w-full overflow-hidden">
      <img src={heroBg} alt="Beautiful tropical paradise" className="absolute inset-0 w-full h-full object-cover"/>
      {/* Dark overlay */}
      ...
      <div className="relative z-10 flex items-center h-full">
        <div className="container-wide">
          <div className="max-w-[600px] text-left ml-0 lg:ml-[40px]">
            ...
            <a href="#destinations" className="inline-block px-8 py-3.5 bg-primary text-primary-foreground font-semibold text-sm rounded-pill hover:-translate-y-[2px] transition-all duration-300 shadow-lg hover:shadow-xl">
              Discover More
            </a>
          </div>
        </div>

      ...
      <div className="container-wide">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="fade-up">
            ...
            <a
              href="#"
              className="inline-block px-8 py-3.5 bg-primary text-primary-foreground font-semibold text-sm rounded-pill hover:-translate-y-[2px] transition-all duration-300 shadow-md hover:shadow-lg"
            >
              View All Packages
            </a>
          </div>

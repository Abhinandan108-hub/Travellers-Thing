...
export default function SearchBar() {
    return (<div className="relative z-20 -mt-[55px]">
        ...
        <div className="bg-background rounded-lg shadow-xl p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5 items-end">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="flex items-center gap-2 border border-border rounded-md px-3 py-2.5">
              ...
              <input type="text" placeholder="Where to?" className="bg-transparent text-sm w-full outline-none placeholder:text-muted-foreground"/>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="flex items-center gap-2 border border-border rounded-md px-3 py-2.5">
              ...
              <input type="date" className="bg-transparent text-sm w-full outline-none text-muted-foreground"/>
            </div>
          </div>
